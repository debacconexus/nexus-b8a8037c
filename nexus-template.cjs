...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Justice-Involved Veteran Case Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "veteran_case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "veteran_case_records";
'use strict';
